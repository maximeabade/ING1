 ...
 */
final class Version20190110150131 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, adresse_id INT NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, e_mail VARCHAR(255) NOT NULL, date_ajout DATETIME NOT NULL, INDEX IDX_C27C9369A4AEAFEA (entreprise_id), INDEX IDX_C27C93694DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
